...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
    ...
    public void initPP() {
        ...
        SwerveModuleState[] currentStates = this.getState().ModuleStates; // Method to get the current swerve module
                                                                          // states
        previousSetpoint = new SwerveSetpoint(currentSpeeds, currentStates,
                DriveFeedforwards.zeros(ppConfig.numModules));
    }
    ...
    public double getCloseTrench() {
        return getPose().getY() > FieldConstants.centerLineY ? FieldConstants.topTrenchAlignLine
                : FieldConstants.bottomTrenchAlignLine;
    }
}
